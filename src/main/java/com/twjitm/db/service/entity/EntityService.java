...
import com.twjitm.db.common.annotation.DbMapper;
...
import com.twjitm.db.entity.BaseLongIDEntity;
import com.twjitm.db.entity.BaseStringIDEntity;
import com.twjitm.db.entity.IEntity;
import com.twjitm.db.service.mapper.IDBMapper;
import com.twjitm.db.service.proxy.EntityProxyWrapper;
import com.twjitm.db.sharding.CustomerContextHolder;
...
public abstract class EntityService<T extends AbstractEntity> implements IEntityService<T> {
    ...
    @Override
    @DbOperation(operation = DbOperationEnum.QUERY_LIST)
    ...
    public void updateEntity(T entity) {
        ...
        if (entityProxyWrapper != null && entityProxyWrapper.getEntityProxy().isDirtyFlag()) {
            ...
            logger.error("更新实体数据 发生异常：" + entity.getClass().getSimpleName() + "id:" + entity.getId() + " userId:" + entity.getUserId());
        }
    }
    ...
    @Override
    @DbOperation(operation = DbOperationEnum.INSERT_BATCH)
    public List<Long> insertEntityBatch(List<T> entityList) {
        ...
        try {
            ...
            logger.error("INSERT_BATCH error " + e.toString(), e);
    ...
    @Override
    @DbOperation(operation = DbOperationEnum.UPDATE_BATCH)
    ...
    @Override
    @DbOperation(operation = DbOperationEnum.DELETE_BATCH)
